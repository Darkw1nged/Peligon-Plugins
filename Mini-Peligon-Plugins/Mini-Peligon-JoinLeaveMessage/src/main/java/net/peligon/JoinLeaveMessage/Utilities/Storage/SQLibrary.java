package net.peligon.JoinLeaveMessage.Utilities.Storage;
...
public class SQLibrary {
    ...
    public SQLibrary(String host, int port, String database, String username, String password) {
        ...
        try {
            ...
            log("An error occurred when trying to connect to the MySQL database.");
    ...
    public void openConnection() throws SQLException, ClassNotFoundException {
        synchronized (this) {
            ...
            if (connection == null || connection.isClosed()) {
                log("An error occurred while trying" + " to connect to the MySQL/SQLite server/database.");
            }
        }
    }
